...
export class CountryCode extends Component {
    ...
    renderList = (array) => {
        ...
        array.map((o, i) => {
            if (o.name[0] != letter) {
                if (hashset.length != 0) {
                    //res[letter] = hashset;
                    res.push(this.renderSection(letter, hashset));
                }
                hashset = [];
                hashset.push(o);
                letter = o.name[0];
    ...
    renderSection = (letter, countryArray) => {
        return (
            <View key={letter} style={styles.section}>
                <View style={{ width: 64 }}>
                    <Text style={{ marginLeft: 16, marginTop: 10.5, fontSize: 25 }} >{letter}</Text>
                </View>
                            ...
                            return (
                                <TouchableOpacity key={i} style={{ height: 56, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row' }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ lineHeight: 17, width: 160, marginLeft: 8, fontSize: 15 }} >{o.name}</Text>
                                    </View>
                                    <Text style={{ lineHeight: 16, fontSize: 16, textAlign: 'right', width: 80, paddingRight: 32 }} >{o.dial_code}</Text>
                                </TouchableOpacity>
                            )
                        })
                    }
    ...
    renderSearchSection = (countryArray) => {
        return (
    ...
    renderSearchResult = () => {
        ...
        return this.renderSearchSection(res);
    }
