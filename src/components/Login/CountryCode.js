                        ...
                        countryArray.map((o, i) => {
                            return (
                                <TouchableOpacity key={i} style={{ height: 56, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row' }}>
                                    ...
                                    <Text style={{ lineHeight: 16, marginRight: 32, fontSize: 16 }} >{o.dial_code}</Text>
                                </TouchableOpacity>
                            )
                        })
                    }
