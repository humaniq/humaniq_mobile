...
const countryArray = [
  ...
  { name: 'Pitcairn Islands', dial_code: '+64', code: 'PN' },
...
export class CountryCode extends Component {
  ...
  toggleSearch = () => {
    if (this.state.isSearchActive) {
      this.setState({ isSearchActive: false, searchText: '' });
    } else {
  ...
  renderObj(o) {
    ...
    return (
      <CountryListItem o={o} resname={resname} onBackPress={this.onBackPress} />
    );
  }
