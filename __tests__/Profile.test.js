...
describe('<Profile />', () => {
  ...
  test('should render correctly', () => {
    const component = shallow(<Profile navigation={navigation} store={store} primaryAccount={user2} />);
  ...
  test('ProfileSettings component should render correctly', () => {
    const component = shallow(<ProfileSettings navigation={navigation} store={store} primaryAccount={user2} password={password} />);
    expect(component).toMatchSnapshot();
    expect(component.length).toBe(1);
  });
  ...
  test('ProfileSettings component should handle initial states', () => {
    ...
    const component = shallow(<Profile navigation={navigation} store={store} primaryAccount={user2} password={password} />);
    expect(component.state().modalVisibility).toEqual(false);
  ...
  test('ProfileEdit component should render correctly', () => {
    const component = shallow(<ProfileEdit navigation={navigation} store={store} primaryAccount={user2} />);
    expect(component).toMatchSnapshot();
    expect(component.length).toBe(1);
  });
